...
for i in puzzleList:
    item = i.split(": ")
    password = item[1]
    ranges = item[0].split(" ")[0]
    lowest = int(ranges.split("-")[0])
    highest = int(ranges.split("-")[1])
    letter = item[0].split(" ")[1]

    if password.count(letter) >= lowest and password.count(letter) <= highest:
        validPasswords += 1

print("Valid passwords at Step 1", validPasswords)
...
for i in puzzleList:
    item = i.split(": ")
    password = item[1]
    positions = item[0].split(" ")[0]
    lowestPosition = int(positions.split("-")[0])
    highestPosition = int(positions.split("-")[1])
    letter = item[0].split(" ")[1]

    if (password[lowestPosition - 1] == letter and password[highestPosition - 1] != letter) or (password[lowestPosition - 1] != letter and password[highestPosition - 1] == letter):
        validPasswords += 1

print("Valid passwords at Step 2", validPasswords)
